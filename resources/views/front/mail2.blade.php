...
<table style=" border: 1px solid black;width: 100%;border-collapse: collapse">
    ...
    <tr>
        <td style=" border: 1px solid black;text-align: center;width: 20%;color: red;padding: 15px">{{$user->email}}</td>
        <td style=" border: 1px solid black;text-align: center;width: 20%;color: red;padding: 15px">{{$user->fname}}{{$user->lname}}</td>
    </tr>
    <tr style=" border: 1px solid black">
        <th style=" border: 1px solid black"> شهر</th>
        <th style=" border: 1px solid black">استان</th>
    </tr>
    <tr>
        <td style=" border: 1px solid black;text-align: center;width: 20%;color: red;padding: 15px">{{$user->city}}</td>
        <td style=" border: 1px solid black;text-align: center;width: 20%;color: red;padding: 15px">{{$user->province}}</td>
    </tr>
    <tr style=" border: 1px solid black">
        <th style=" border: 1px solid black"> تلفن</th>
        <th style=" border: 1px solid black">کد پستی</th>
    </tr>
    <tr>
        <td style=" border: 1px solid black;text-align: center;width: 20%;color: red;padding: 15px">{{$user->phone}}</td>
        <td style=" border: 1px solid black;text-align: center;width: 20%;color: red;padding: 15px">{{$user->postcode}}</td>
    </tr>
    <tr style=" border: 1px solid black">
    ...
    <tr>
        <td style=" border: 1px solid black;text-align: center;width: 20%;color: red;padding: 15px">{{$user->address}}</td>
        <td style=" border: 1px solid black;text-align: center;width: 20%;color: red;padding: 15px">{{$userlists->comment}}</td>
    </tr>
